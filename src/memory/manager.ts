...
export class MemoryIndexManager implements MemorySearchManager {
  ...
  private readonly requestedProvider: "openai" | "local" | "gemini" | "ollama" | "voyage" | "auto";
  private fallbackFrom?: "openai" | "local" | "gemini" | "ollama" | "voyage";
  ...
  private async activateFallbackProvider(reason: string): Promise<boolean> {
    ...
    const fallbackFrom = this.provider.id as "openai" | "local" | "gemini" | "ollama" | "voyage";
